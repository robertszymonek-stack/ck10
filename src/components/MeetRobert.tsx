      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="grid items-center gap-12 lg:grid-cols-[0.8fr_1.2fr]">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -right-4 rounded-2xl bg-gradient-to-r from-sky-400 to-cyan-400 px-5 py-3 text-sm font-bold text-slate-950 shadow-lg">
          ...
          <div>
            ...
            <p className="mt-2 text-lg font-semibold text-sky-600">
              Twój doradca klimatyzacji w Białołęce i okolicach
            </p>

            <p className="mt-5 text-base leading-relaxed text-slate-600">
              Pomagam mieszkańcom <strong>Białołęki, Targówku, Marek i okolic</strong> w doborze i montażu klimatyzacji od podstaw. Bez stresu, bez ukrytych kosztów, bez czekania tygodniami na wycenę.
            </p>
            ...
            <div className="mt-8">
              ...
              <ul className="mt-5 space-y-4">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <strong className="text-slate-900">⏱️ Wycena w 15 minut</strong>
                    <p className="mt-0.5 text-sm text-slate-600">Wideokonsultacja przez WhatsApp — pokazujesz wnętrze, dostajesz konkretną cenę tego samego dnia</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-1 flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-emerald-100 text-emerald-600">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <strong className="text-slate-900">🏆 Autoryzacje 7 marek</strong>
                    <p className="mt-0.5 text-sm text-slate-600">Mitsubishi Electric, LG, Gree, Haier, Rotenso, Kaisai, AUX — pełna gwarancja producenta</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-1 flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-emerald-100 text-emerald-600">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-sm text-slate-600">Lokalna ekipa — w razie awarii jesteśmy u Ciebie w lada dzień, nie za 3 tygodnie.</p>
                  </div>
                </li>
              </ul>
            </div>
